...
package com.google.logicoin.examples;

import com.google.logicoin.core.*;
import com.google.logicoin.kits.WalletAppKit;
import com.google.logicoin.params.TestNet3Params;
import com.google.logicoin.protocols.channels.PaymentChannelClientConnection;
import com.google.logicoin.protocols.channels.StoredPaymentChannelClientStates;
import com.google.logicoin.protocols.channels.ValueOutOfRangeException;
...
import static com.google.logicoin.core.Utils.CENT;
...
public class ExamplePaymentChannelClient {
    ...
    private void waitForSufficientBalance(BigInteger amount) {
        ...
        if (!balanceFuture.isDone()) {
            System.out.println("Please send " + Utils.logicoinValueToFriendlyString(amountPlusFee) +
