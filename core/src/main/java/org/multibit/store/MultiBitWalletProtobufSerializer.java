 ...
 * format is defined by the <tt>logicoin.proto</tt> file in the logicoinj source distribution.<p>
 *
...
public class MultiBitWalletProtobufSerializer extends WalletProtobufSerializer {
    ...
    protected WalletTransaction connectTransactionOutputs(org.logicoinj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
