...
package com.google.logicoin.uri;
 ...
 *
 * <ul>
 * <li>{@code logicoin:<address>}</li>
 * <li>{@code logicoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
 ...
 * @see <a href="https://en.logicoin.it/wiki/BIP_0021">BIP 0021</a>
 */
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "logicoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  logicoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form logicoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the logicoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : logicoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        // the & (%26) in Tom and Jerry gets interpreted as a separator and the label then gets parsed
        // as 'Tom ' instead of 'Tom & Jerry')
        String schemeSpecificPart;
        if (input.startsWith("logicoin://")) {
            schemeSpecificPart = input.substring("logicoin://".length());
        } else if (input.startsWith("logicoin:")) {
            schemeSpecificPart = input.substring("logicoin:".length());
        } else {
    ...
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws BitcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (tokens.length != 2 || "".equals(tokens[0])) {
                throw new BitcoinURIParseException("Malformed Logicoin URI - cannot parse name value pair '" +
                        nameValuePairToken + "'");
            }
    ...
    public static String convertToBitcoinURI(String address, BigInteger amount, String label, String message) {
        ...
        if (amount != null) {
            ...
            builder.append(Utils.logicoinValueToPlainString(amount));
