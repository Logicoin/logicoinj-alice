...
public class Peer {
    ...
    private String ACCEPTED_SUBVERSION = "Satoshi:0.9.1.5";
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that logicoin-qt is single threaded and processes messages in order.
    ...
    private final long MIN_PEER_BLOCK_HEIGHT = 60;
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) throws IOException {
        ...
        //
        //   https://en.logicoin.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link com.google.logicoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.logicoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.logicoin.core.Peer#ping()} has never
