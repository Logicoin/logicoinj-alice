...
import com.google.logicoin.IsMultiBitClass;
import com.google.logicoin.core.TransactionConfidence.ConfidenceType;
import com.google.logicoin.core.WalletTransaction.Pool;
...
import com.google.logicoin.store.UnreadableWalletException;
import com.google.logicoin.store.WalletProtobufSerializer;
import com.google.logicoin.utils.ListenerRegistration;
import com.google.logicoin.utils.Threading;
import com.google.logicoin.wallet.KeyTimeCoinSelector;
import com.google.logicoin.wallet.WalletFiles;
...
import static com.google.logicoin.core.Utils.logicoinValueToFriendlyString;
 ...
 *
 * <p>To learn more about this class, read <b><a href="http://code.google.com/p/logicoinj/wiki/WorkingWithTheWallet">
 ...
 * other objects, see the <a href="http://code.google.com/p/logicoinj/wiki/GettingStarted">Getting started</a> tutorial
 * on the website to learn more about how to set everything up.</p>
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of logicoinj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.logicoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider, IsMultiBitClass {
        ...
        try {
            ...
            if (log.isInfoEnabled()) {
                log.info(String.format("Received a pending transaction %s that spends %s %s from our own wallet," +
                        " and sends us %s %s", tx.getHashAsString(), Utils.logicoinValueToFriendlyString(valueSentFromMe), CoinDefinition.coinTicker,
                        Utils.logicoinValueToFriendlyString(valueSentToMe),CoinDefinition.coinTicker));
            }
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType,
        ...
        if (!insideReorg && bestChain) {
            ...
            log.info("Balance is now: " + logicoinValueToFriendlyString(newBalance));
            if (!wasPending) {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.logicoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.logicoin.core.Wallet.SendRequest)} is called, this is set to the
    ...
    public boolean completeTx(SendRequest req, boolean sign) {
        ...
        try {
            ...
            log.info("Completing send tx with {} outputs totalling {} (not including fees)",
                    req.tx.getOutputs().size(), logicoinValueToFriendlyString(value));
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
            ...
            if (bestChangeOutput != null) {
                ...
                log.info("  with {} coins change", logicoinValueToFriendlyString(bestChangeOutput.getValue()));
            }
            final BigInteger calculatedFee = totalInput.subtract(totalOutput);
            if (calculatedFee.compareTo(BigInteger.ZERO) > 0) {
                log.info("  with a fee of {}", logicoinValueToFriendlyString(calculatedFee));
            }
            ...
            // Check size.
            int size = req.tx.logicoinSerialize().length;
    ...
    private boolean adjustOutputDownwardsForFee(Transaction tx, CoinSelection coinSelection, BigInteger baseFee, BigInteger feePerKb) {
        ...
        int size = tx.logicoinSerialize().length;
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.logicoin.wallet.WalletFiles.Listener)}
    ...
    private void toStringHelper(StringBuilder builder, Map<Sha256Hash, Transaction> transactionMap,
        ...
        for (Transaction tx : transactionMap.values()) {
            try {
                ...
                builder.append(Utils.logicoinValueToFriendlyString(tx.getValueSentFromMe(this)));
                builder.append(" and receives ");
                builder.append(Utils.logicoinValueToFriendlyString(tx.getValueSentToMe(this)));
                builder.append(", total value ");
                builder.append(Utils.logicoinValueToFriendlyString(tx.getValue(this)));
                builder.append(".\n");
            } catch (ScriptException e) {
    ...
    public void reorganize(StoredBlock splitPoint, List<StoredBlock> oldBlocks, List<StoredBlock> newBlocks) throws VerificationException {
        ...
        try {
            ...
            log.info("post-reorg balance is {}", Utils.logicoinValueToFriendlyString(balance));
     ...
     * {@link com.google.logicoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.logicoin.crypto.KeyCrypter,
     ...
     * {@link com.google.logicoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all logicoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.logicoin.crypto.KeyCrypter,
            ...
            for (int i = 0; i < tx.getOutputs().size(); i++) {
                ...
                try {
                    if (out.isMine(this) && out.getScriptPubKey().isSentToRawPubKey()) {
                        ...
                        filter.insert(outPoint.logicoinSerialize());
                    }
                } catch (ScriptException e) {
                    throw new RuntimeException(e); // If it is ours, we parsed the script correctly, so this shouldn't happen
                }
     ...
     * you can use {@link com.google.logicoin.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    private class FeeCalculation {
        ...
        public FeeCalculation(SendRequest req, BigInteger value, List<TransactionInput> originalInputs,
            ...
            while (true) {
                ...
                size += req.tx.logicoinSerialize().length;
            ...
            if (selection3 == null && selection2 == null && selection1 == null) {
                log.warn("Insufficient value in wallet for send: needed {}", logicoinValueToFriendlyString(valueNeeded));
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.logicoin.core.TransactionBroadcaster broadcaster) {
        lock.lock();
        try {
    ...
    private Transaction rekeyOneBatch(long keyRotationTimestamp, final TransactionBroadcaster broadcaster) {
        ...
        try {
            ...
            checkState(rekeyTx.logicoinSerialize().length < Transaction.MAX_STANDARD_TX_SIZE);
            commitTx(rekeyTx);
        } catch (VerificationException e) {
