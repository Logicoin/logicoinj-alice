...
import com.google.logicoin.params.TestNet2Params;
import com.google.logicoin.params.TestNet3Params;
import com.google.logicoin.params.UnitTestParams;
...
import static com.google.logicoin.core.Utils.COIN;
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final int TARGET_TIMESPAN = CoinDefinition.TARGET_TIMESPAN; // 4h per difficulty cycle, on average.
    public static final int TARGET_SPACING = CoinDefinition.TARGET_SPACING;;  // 1 minutes per block.
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.logicoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.logicoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.logicoin.core.AlertMessage}s. You can use {@link com.google.logicoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
