...
public abstract class Message implements Serializable {
    ...
    private void selfCheck(byte[] msg, int offset) {
        if (!(this instanceof VersionMessage)) {
            ...
            byte[] reserialized = logicoinSerialize();
    ...
    /**
     * Serialize this message to a byte array that conforms to the logicoin wire protocol.
     * <br/>
    ...
    public byte[] unsafeBitcoinSerialize() {
        ...
        try {
            logicoinSerializeToStream(stream);
        } catch (IOException e) {
        ...
        if (parseRetain) {
            ...
            // which means another call to logicoinSerialize is coming.  If we didn't recache then internal
    ...
    /**
     * Serialize this message to the provided OutputStream using the logicoin wire format.
     *
     * @param stream
     * @throws IOException
     */
    final public void logicoinSerialize(OutputStream stream) throws IOException {
    ...
    /**
     * Serializes this message to the provided stream. If you just want the raw bytes use logicoinSerialize().
     */
    void logicoinSerializeToStream(OutputStream stream) throws IOException {
        log.debug("Warning: {} class has not implemented logicoinSerializeToStream method.  Generating message with no payload", getClass());
    }
