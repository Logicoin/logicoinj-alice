 ...
 * <a href="https://en.logicoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.logicoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class BitcoinSerializer {
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        serialize(name, message.logicoinSerialize(), out);
    }
