...
public class VersionMessage extends Message {
    ...
    @Override
    public void logicoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.logicoinSerialize(buf);
            // Their address.
            theirAddr.logicoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     *
     * See <a href="https://en.logicoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
