...
import com.google.logicoin.core.Peer.PeerHandler;
import com.google.logicoin.discovery.PeerDiscovery;
import com.google.logicoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService implements TransactionBroadcaster {
    ...
    // pipeline with the logicoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.logicoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.logicoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.logicoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.logicoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.logicoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.logicoin.core.Peer#ping()}.
     */
