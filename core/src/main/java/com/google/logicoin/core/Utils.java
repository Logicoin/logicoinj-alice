 ...
 * To enable debug logging from the library, run with -Dlogicoinj.logging=true on your command line.
 */
public class Utils {
     ...
     */
    public static String logicoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String logicoinValueToPlainString(BigInteger value) {
        if (value == null) {
