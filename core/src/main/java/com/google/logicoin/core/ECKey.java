...
import org.logicoin.NativeSecp256k1;
...
public class ECKey implements Serializable {
     ...
     * usually encoded using DER format, so you want {@link com.google.logicoin.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link com.google.logicoin.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * determine if the signature was correct. These sorts of signatures are compatible with the Bitcoin-Qt/logicoind
     ...
     * the {@link com.google.logicoin.core.DumpedPrivateKey#toString()} method to get the string.
     *
     ...
     *
     * Because it is a critical failure if the private keys cannot be decrypted successfully (resulting of loss of all logicoins controlled
