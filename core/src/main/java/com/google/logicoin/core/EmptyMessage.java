 ...
 * Currently this includes getaddr, ping, verack as well as the special logicoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void logicoinSerializeToStream(OutputStream stream) throws IOException {
    }
