...
public class TransactionOutput extends ChildMessage implements Serializable, IsMultiBitClass {
     ...
     *
     * <p>You probably should use {@link com.google.logicoin.core.TransactionOutput#getMinNonDustValue()} which uses
    ...
    public BigInteger getMinNonDustValue(BigInteger feePerKbRequired) {
        ...
        final BigInteger size = BigInteger.valueOf(this.logicoinSerialize().length + 148);
    ...
    */
    ...
    public String toString() {
        try {
            return "TxOut of " + Utils.logicoinValueToFriendlyString(value) + " to " +
