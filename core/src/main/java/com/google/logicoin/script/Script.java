...
package com.google.logicoin.script;
...
import static com.google.logicoin.script.ScriptOpCodes.*;
import static com.google.logicoin.core.Utils.bytesToHexString;
 ...
 *
 * <p>Bitcoin transactions don't specify what they do directly. Instead <a href="https://en.logicoin.it/wiki/Script">a
...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
        ...
        // Otherwise, the third element is the hash of the public key, ie the logicoin address.
     ...
     * logic is defined by <a href="https://en.logicoin.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
     * <p>logicoinj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
    ...
    public void correctlySpends(Transaction txContainingThis, long scriptSigIndex, Script scriptPubKey,
        ...
        try {
            txContainingThis = new Transaction(txContainingThis.getParams(), txContainingThis.logicoinSerialize());
