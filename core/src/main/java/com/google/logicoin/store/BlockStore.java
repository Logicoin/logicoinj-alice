...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.logicoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.logicoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
