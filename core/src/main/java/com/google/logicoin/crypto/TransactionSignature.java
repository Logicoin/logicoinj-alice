...
package com.google.logicoin.crypto;
...
/**
 * A TransactionSignature wraps an {@link com.google.logicoin.core.ECKey.ECDSASignature} and adds methods for handling
...
public class TransactionSignature extends ECKey.ECDSASignature {
    ...
    public static boolean isEncodingCanonical(byte[] signature) {
        // See reference client's IsCanonicalSignature, https://logicointalk.org/index.php?topic=8392.msg127623#msg127623
