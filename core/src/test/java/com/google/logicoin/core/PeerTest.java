...
//            @Override
//            public void logicoinSerializeToStream(OutputStream stream) throws IOException {
//                // Add some hashes.
...
//                super.logicoinSerializeToStream(bos);
//                byte[] bits = bos.toByteArray();
//                bits = Arrays.copyOf(bits, bits.length / 2);
//                stream.write(bits);
//            }
//        }.logicoinSerialize(), socket.getOutputStream());
//        try {
//            result.get();
//            fail();
