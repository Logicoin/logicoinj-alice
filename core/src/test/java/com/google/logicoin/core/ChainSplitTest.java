...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals("100.00", Utils.logicoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("50.00", Utils.logicoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("200.00", Utils.logicoinValueToFriendlyString(wallet.getBalance()));
    }
    ...
    private Block roundtrip(Block b2) throws ProtocolException {
        return new Block(unitTestParams, b2.logicoinSerialize());
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals("250.00", Utils.logicoinValueToFriendlyString(wallet.getBalance()));
