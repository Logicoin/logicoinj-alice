...
import com.google.logicoin.core.Transaction.SigHash;
...
import com.google.logicoin.utils.TestUtils;
import com.google.logicoin.utils.TestWithWallet;
...
import static com.google.logicoin.utils.TestUtils.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void blockChainCatchup() throws Exception {
        ...
        Threading.waitForUserCode();
        assertEquals(logicoinValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(logicoinValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(logicoinValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(logicoinValueToFriendlyString(wallet.getBalance()), "0.80");
        Threading.waitForUserCode();
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.logicoinSerialize());
...
//        
//        Transaction txClone = new Transaction(params, tx.logicoinSerialize());
//        try {
...
//        assertFalse(wallet.isConsistent());
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.logicoinSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.logicoinSerialize());
...
//        File f = File.createTempFile("logicoinj-unit-test", null);
...
//    }
    ...
    public void feeSolverAndCoinSelectionTest() throws Exception {
        ...
        assertTrue(request15.tx.logicoinSerialize().length > 1000);
        ...
        assertTrue(request16.tx.logicoinSerialize().length > 1000);
        ...
        int theoreticalMaxLength17 = request17.tx.logicoinSerialize().length + myKey.getPubKey().length + 75;
        ...
        Transaction spend17 = request17.tx;
        {
            ...
            final int length = spend17.logicoinSerialize().length;
        ...
        int theoreticalMaxLength18 = spend18.logicoinSerialize().length + myKey.getPubKey().length + 75;
        ...
        assertTrue(spend18.logicoinSerialize().length >= 998);
        assertTrue(spend18.logicoinSerialize().length <= 1001);
        ...
        assertTrue(request26.tx.logicoinSerialize().length > 1000);
    ...
    public void basicCategoryStepTest() throws Exception {
        ...
        request4.feePerKb = Transaction.REFERENCE_DEFAULT_MIN_TX_FEE.divide(BigInteger.valueOf(request3.tx.logicoinSerialize().length));
        assertTrue(wallet.completeTx(request4));
