...
/**
 * Test to ensure that the multibit duplicates of logicoinj classes are available
 * correctly
 * 
 * @author jim
 * 
...
public class IsMultiBitClassTest extends TestCase {
    private static final String GOOGLE_PREFIX = "com.google.logicoin.";
    ...
    private void checkClass(String className) throws ClassNotFoundException {
        ...
        if (interfaces == null) {
            ...
            for (int i = 0; i < interfaces.length; i++) {
                if (interfaces[i].getName().equals("com.google.logicoin.IsMultiBitClass")) {
                    success = true;
                    break;
                }
            }
