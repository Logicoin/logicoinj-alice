...
package com.google.logicoin.protocols.channels;
...
import static com.google.logicoin.utils.TestUtils.createFakeTx;
import static com.google.logicoin.utils.TestUtils.makeSolvedTestBlock;
...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void basic() throws Exception {
        ...
        Transaction refund = new Transaction(params, clientState.getIncompleteRefundTransaction().logicoinSerialize());
        ...
        Transaction multisigContract = new Transaction(params, clientState.getMultisigContract().logicoinSerialize());
        ...
        // Both client and server are now in the ready state. Simulate a few micropayments of 0.005 logicoins.
        ...
        chain.add(makeSolvedTestBlock(blockStore.getChainHead().getHeader(), multisigContract,
                                      new Transaction(params, closeTx.logicoinSerialize())));
    ...
    public void checkBadData() throws Exception {
        ...
        byte[] refundTxBytes = clientState.getIncompleteRefundTransaction().logicoinSerialize();
        ...
        byte[] multisigContractSerialized = clientState.getMultisigContract().logicoinSerialize();
    ...
    public void doubleSpendContractTest() throws Exception {
        ...
        doubleSpendContract = new Transaction(params, doubleSpendContract.logicoinSerialize());
